            ...
            <div id="section-img" className="w-full h-auto flex items-center">
                <div id="section-img-text" className="w-[40%] pb-24 pl-16">
                    ...
                    <div id="header-btns" className="w-full flex items-center text-xl mt-12">
                        <a href="#" className="font-bold border border-yellow-color bg-yellow-color text-black py-6 px-14 rounded-full">HIRE ME</a>
                        <a href="#" className="font-bold border border-[#808080] py-6 px-14 rounded-full ml-4">MY WORKS</a>
                    </div>
                </div>
