    ...
    return (
        <div id="Header" className="w-full h-auto">
            ...
            <div id="section-img" className="w-full h-auto flex items-center relative">
                <div id="section-img-text" className="w-[40%] pb-24 pl-16 z-50 md:absolute md:w-[80%] md:ml-28 sm:w-full sm:ml-4">
                    ...
                    <p className="text-5xl text-white mt-6 lg:text-4xl md:text-5xl md:font-bold md:text-black">A FrontEnd Developer</p>
